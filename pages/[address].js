...
import Campaign from '../artifacts/contracts/Campiagn.sol/Campaign.json'
          ...
          <LiveDonation>
            ...
            {DonationsData.map((e) => {
              return (
                ...
                <DonationData>{e.doner}</DonationData>
...
export async function getStaticPaths() {
  ...
  return {
    paths: AllCampaigns.map((e) => ({
        params: {
          address: e.args.campiagnAddress.toString(),
        }
    })),
    fallback: "blocking"
  }
...
const Donate = styled.button`
  ...
  background-image: linear-gradient(180deg,#0e00b7 0%,#15b2ff 80%); 
  border: none;
  cursor: pointer;
  font-weight: bold;
  border-radius: 8px;
